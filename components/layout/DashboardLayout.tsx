  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:hidden flex items-center justify-between p-4 bg-card border-b border-border sticky top-0 z-20">
        <h1 className="text-lg font-display font-bold text-gold">Reunion 2026</h1>
      ...
      {/* Sidebar */}
      <div className={`${mobileMenuOpen ? "block" : "hidden"} lg:block w-full lg:w-56 bg-card border-b lg:border-b-0 lg:border-r border-border flex flex-col ${mobileMenuOpen ? "absolute top-16 left-0 right-0 z-10" : ""}`}>
        {/* User section */}
      ...
      <div className="flex-1 overflow-auto w-full">
        <div className="border-b border-border bg-card/50 sticky top-0 z-10 hidden lg:block">
          <div className="flex items-center justify-between p-4 max-w-full">
            <h1 className="text-2xl font-display font-bold text-gold">Reunion 2026</h1>
          </div>
        </div>
